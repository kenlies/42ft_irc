...
SRC     = main.cpp Server.cpp Client.cpp Channel.cpp Commands.cpp \
		...
		./commands/RPL_LUSERCLIENT.cpp ./commands/RPL_LUSERME.cpp \
...
HEADERS = $(INC_D)/Server.hpp $(INC_D)/Client.hpp $(INC_D)/Channel.hpp $(INC_D)/Commands.hpp \
		  ...
		  $(INC_D)/commands/RPL_UMODEIS.hpp \
		  $(INC_D)/commands/RPL_LUSERCLIENT.hpp $(INC_D)/commands/RPL_LUSERME.hpp \
